...
import menu1 from '../../../src/menu-1.jpg'
import menu2 from '../../../src/menu-2.jpg'
import menu3 from '../../../src/menu-3.jpg'
import menu4 from '../../../src/menu-4.jpg'
import AOS from "aos";
...
const Breakfast = () => {
    ...
    return <>
        ...
        <div>
        <h3 className='text-center fs-1 orange'>BreakFast</h3>
    </div>

            <div data-aos="fade-right" className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div className='rounded-3 item-menu text-start my-3 d-flex justify-content-center shadow-lg p-2'>
                    <div className='w-20'>
