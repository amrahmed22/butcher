...
import menu3 from '../../../src/menu-7.jpg'
import menu4 from '../../../src/menu-8.jpg'
import AOS from "aos";
...
const Lunch = () => {
    ...
    return <>
       ...
       <div>
        <h3 className='text-center fs-1 orange'>Lunch</h3>
    </div>
...
<div data-aos="fade-right" className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
    ...
    <div className='rounded-3 item-menu my-3 d-flex justify-content-center shadow-lg p-2'>
        ...
        <div className='w-20 d-flex align-items-center'>
            <span className='rounded-circle nnn bg-orange text-white p-2 fs-5'>$20</span>
        </div>
    </div>
    <div className='rounded-3 item-menu my-3 d-flex justify-content-center shadow-lg p-2'>
        <div className='w-20'>
        ...
        <div className='w-20 d-flex align-items-center'>
            <span className='rounded-circle nnn bg-orange text-white p-2 fs-5'>$75</span>
        </div>
    </div>
</div>
<div data-aos="fade-left" className="col-xl-6 col-lg-6 col-md-12 col-sm-12">
    <div className='rounded-3 item-menu my-3 d-flex justify-content-center shadow-lg p-2'>
        ...
        <div className='w-20 d-flex align-items-center'>
            <span className='rounded-circle nnn bg-orange text-white p-2 fs-5'>$85</span>
        </div>
    </div>
    <div className=' rounded-3 item-menu my-3 d-flex justify-content-center shadow-lg p-2'>
        <div className='w-20'>
        ...
        <div className='w-20 d-flex align-items-center'>
            <span className='rounded-circle nnn bg-orange text-white p-2 fs-5'>$84</span>
        </div>
    </div>
    <div className=' rounded-3 item-menu my-3 d-flex justify-content-center shadow-lg p-2'>
        <div className='w-20'>
